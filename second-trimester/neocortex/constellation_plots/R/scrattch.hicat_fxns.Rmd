...
get_knn_graph <- function(rd.dat, cl, cl.df, 
...
plot_constellation <- function(knn.cl.df, cl.center.df, out.dir, 
  ...
  #plot.all
    ...
    plot.all <-  ggplot() +
      ...
      ggtitle(paste("n_pcs:", n.pcs, "\n", "k=", k, "\n", "threshold:", frac.th))
    #plot.all
  }
# plot.hull = FALSE
ggsave(plot = plot.all, file.path(out.dir, paste0(st, "constellation.pdf")), height = 11, width = 8, units = "in")
  ...
  leg.col.nr <- min((ceiling(length(cl.center.df$cl_id)/20)), 5)
